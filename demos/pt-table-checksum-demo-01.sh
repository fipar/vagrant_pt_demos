...
$PTBIN/pt-table-checksum --defaults-file=$DEMOS_HOME/assets/.my.cnf --replicate=percona.checksums --create-replicate-table --empty-replicate-table h=127.0.0.1,P=13306,u=demo,p=demo
$PTBIN/pt-table-checksum --defaults-file=$DEMOS_HOME/assets/.my.cnf --replicate=percona.checksums --replicate-check --replicate-check-only h=127.0.0.1,P=13306,u=demo,p=demo
...
$PTBIN/pt-table-checksum --defaults-file=$DEMOS_HOME/assets/.my.cnf --replicate=percona.checksums --create-replicate-table --empty-replicate-table --replicate-check  h=127.0.0.1,P=13306,u=demo,p=demo
$PTBIN/pt-table-checksum --defaults-file=$DEMOS_HOME/assets/.my.cnf --replicate=percona.checksums --replicate-check --replicate-check-only h=127.0.0.1,P=13306,u=demo,p=demo
